    ...
    <div className="w-full">
      ...
      <section className="min-h-[88vh] flex flex-col items-center justify-center text-center px-4 py-20 relative overflow-hidden">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full
                     ...
                     text-brand-primary text-xs font-black uppercase tracking-widest mb-8"
        >
        ...
        >
          {/* Primary — uses existing neu-primary-btn class */}
          <button
        ...
        <motion.div
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1
                     text-zinc-400 text-[10px] font-bold uppercase tracking-widest"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <motion.article
              ...
              className="home-reveal glass-card rounded-[2rem] p-8 relative overflow-hidden group"
      ...
      <section id="how-it-works" className="py-24 px-4 bg-zinc-900 dark:bg-zinc-950 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="home-reveal mb-14">
            <p className="text-xs font-black uppercase tracking-widest text-brand-primary/60 mb-2">
              How it works?
            </p>
            <h2 className="text-4xl sm:text-5xl font-black tracking-tighter text-zinc-100 leading-tight">
              Simple as 1 – 2 – 3
            </h2>
            <p className="mt-3 text-zinc-500 font-medium max-w-sm">
              Get started in under a minute. No setup, no complexity.
            </p>
          </div>
            ...
            {[
              {
                ...
                color: 'brand-primary',
                label: 'Step One',
                text: 'Press get started and then sign in using your email or Google',
                note: 'Quick and secure — no password required if you use Google.',
              },
              {
                n: '2',
                color: 'brand-secondary',
                label: 'Step Two',
                text: 'Simply click "Add URL", enter your website title, subtitle and link, then save',
                note: 'Takes about 10 seconds per link. Edit or delete anytime from your dashboard.',
              },
              {
                n: '3',
                color: 'brand-accent',
                label: 'Step Three',
                text: 'Click "Playlist" if you want to save multiple links of the same category website',
                note: 'Group related links into one playlist — e.g. all design tools or study resources.',
              },
            ].map((step, i) => (
              <div
                key={step.n}
                className="home-reveal relative mb-12 last:mb-0"
                style={{ transitionDelay: `${i * 0.12}s` }}
              >
                {/* Dot */}
                <div
                  className={`absolute -left-6 top-0.5 w-7 h-7 rounded-full flex items-center justify-center
                              text-white text-xs font-black
                              bg-gradient-to-br
                              ${step.color === 'brand-primary' ? 'from-indigo-400 to-indigo-600' : ''}
                              ${step.color === 'brand-secondary' ? 'from-pink-400 to-pink-600' : ''}
                              ${step.color === 'brand-accent' ? 'from-amber-400 to-amber-600' : ''}
                              shadow-lg`}
                >
                  {step.n}
                </div>
        ...
        <div className="max-w-2xl mx-auto text-center relative z-10">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-black tracking-tighter text-zinc-900 dark:text-zinc-100 leading-tight mb-4">
              ...
              and save time with full free{' '}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-brand-primary via-brand-secondary to-brand-accent">
                BioSnap?
              </span>
            </h2>
            <p className="text-zinc-500 dark:text-zinc-400 font-medium mb-10 leading-relaxed">
              Join thousands of people who have already simplified their digital life.
              No credit card. No catch.
            </p>

            <button
              onClick={onGetStarted}
              className="neu-primary-btn inline-flex items-center gap-3 px-10 py-5 rounded-2xl font-black text-xl mx-auto"
            >
              <span>✧</span>
              Get started
              <ArrowRight size={22} />
            ...
            <p className="mt-6 text-xs font-bold uppercase tracking-widest text-zinc-400">
