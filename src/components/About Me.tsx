        ...
        <div className="p-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
              Hi, I'm Nishat Alam, a student and a dedicated coder. I have a passion for creating
              simple, practical tools that help people manage their digital life more efficiently.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
              I created Biosnap, a lightweight link organizer designed to solve the common problem of
              losing track of important websites. Many users visit multiple websites daily, and finding
              them later can be frustrating. Biosnap provides a central place to save, organize, and
              access your links quickly and easily.
            </p>
          </div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={i} className="flex items-start gap-2 text-base text-zinc-600 dark:text-zinc-400">
                  <span className="mt-1.5 w-2 h-2 rounded-full bg-gradient-to-r from-brand-primary to-brand-secondary flex-shrink-0" />
                  {feature}
                </li>
              ))}
            </ul>
          ...
          <div className="mb-6">
            ...
            <p className="text-base text-zinc-600 dark:text-zinc-400 leading-relaxed">
              All user data remains private. No information is collected or shared, ensuring 100%
